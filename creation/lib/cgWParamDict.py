...
def populate_job_descript(
    ...
    job_descript_dict.add("StaleAgeIdle", stale_age["idle"])
    job_descript_dict.add("StaleAgeRunning", stale_age["running"])
    job_descript_dict.add("StaleAgeUnclaimed", stale_age["unclaimed"])
    submit = config.get_child("submit")
